          ...
          <div className="mx-auto w-full md:w-[80%]">
            ...
            <div>
              ...
              >
                ...
                of what's possible. As a developer, I derive a lot of
                satisfaction from streamlining and improving difficult code, and
                I'm always looking for fresh approaches to challenges. <br /> My
                skillset includes proficiency in HTML, CSS, JavaScript, Tailwind
                CSS, React JS, Framer Motion and vesrion control (Git). <br />{" "}
                <br />
